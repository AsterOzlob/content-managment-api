...
| `GET` | `/users/:id` | `user`, `admin` | Получение информации о пользователе |
...
| `PUT` | `/articles/:id` | `author`, `moderator`, `admin` | Обновление статьи |
| `DELETE` | `/articles/:id` | `author`, `moderator`, `admin` | Удаление статьи |
...
| `PUT` | `/articles/comments/:id` | Все | Редактирование комментария |
| `DELETE` | `/comments/:id` | `author`, `moderator`, `admin` | Удаление комментария |
...
| `DELETE` | `/media/:id` | `author`, `moderator`, `admin` | Удаление медиафайла |

| `POST` | `/roles` | `admin` | Создание новой роли |
| `GET` | `/roles` | `admin` | Получение списка ролей |
| `GET` | `/roles/:id` | `admin` | Получение информации о роли |
| `PUT` | `/roles/:id` | `admin` | Обновление роли |
